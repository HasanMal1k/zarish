...
const servicesData: Service[] = [
  {
    ...
    icon: (
      // Use SVG icon for Web Design (as before)
            ...
            >
              <div
                className={cn(
                  ...
                  "hover:drop-shadow-[0_0_22px_rgba(80,143,255,0.8)]" // blue glow on hover
                )}
              >
              ...
              <div className="flex flex-col items-center w-full px-2">
                ...
                <ul className="space-y-1 w-full max-w-xs mx-auto text-left flex flex-col items-start">
